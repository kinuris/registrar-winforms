...
namespace PrjRegistrar {
    ...
    public class RptPersonalDataList : ReportClass {
        
        public RptPersonalDataList() {
        }
        
        public override string ResourceName {
            get {
                return "RptPersonalDataList.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "PrjRegistrar.RptPersonalDataList.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptPersonalDataList : Component, ICachedReport {
        
        public CachedRptPersonalDataList() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptPersonalDataList rpt = new RptPersonalDataList();
            rpt.Site = this.Site;
            return rpt;
        }
