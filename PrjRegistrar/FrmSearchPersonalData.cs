...
{
    public partial class FrmSearchPersonalData : Form
    {
        ...
        private void FrmSearchStudent_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlDA = new MySqlDataAdapter("mtbl_studprofile_search", mysqlcon);
                ...
                sqlDA.Fill(dtbl);
                sqlDA.Fill(pagingDS, scrollVal, dtbl.Rows.Count, "mtbl_studprofile");

                dgvStudent.DataSource = pagingDS;
                dgvStudent.DataMember = "mtbl_studprofile";
        ...
        private void Txtsearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlDataAdapter sqlDA = new MySqlDataAdapter("mtbl_studprofile_searchbyparam", mysqlcon);
                sqlDA.SelectCommand.CommandType = CommandType.StoredProcedure;
